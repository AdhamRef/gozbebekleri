...
export const DASHBOARD_NAV_GROUPS: {
  ...
  },
  {
    ...
    items: [
      { key: "operations", title: "نظرة عامة", href: "/dashboard/operations" },
      { key: "operations", title: "مركز قيادة المحتوى", href: "/dashboard/operations/command-center" },
      { key: "operations", title: "التقويم والتنبيهات", href: "/dashboard/operations/calendar" },
      { key: "operations", title: "جدولة المحتوى", href: "/dashboard/operations/scheduler" },
      { key: "operations", title: "مهام الإنتاج", href: "/dashboard/operations/tasks" },
      { key: "operations", title: "لوحة الإنتاج", href: "/dashboard/operations/production" },
      { key: "operations", title: "الأرشيف", href: "/dashboard/operations/archive" },
      { key: "operations", title: "مساعد المحتوى AI", href: "/dashboard/operations/ai-assistant" },
      { key: "operations", title: "مساعد الأرشيف AI", href: "/dashboard/operations/archive/ai-assistant" },
      { key: "operations", title: "لوحة المحتوى", href: "/dashboard/operations/content" },
      { key: "operations", title: "خريطة النظام", href: "/dashboard/operations/system" },
    ],
  },
  {
    ...
    items: [
      ...
      { key: "ads", title: "مركز تشغيل الحملات", href: "/dashboard/marketing/campaign-operating-center" },
      { key: "ads", title: "سجل روابط الحملات", href: "/dashboard/marketing/campaign-links" },
      ...
      { key: "pixels", title: "مركز التتبع", href: "/dashboard/marketing/tracking-hub" },
  ...
  },
  {
    ...
    items: [
      { key: "brand", title: "مركز الهوية", href: "/dashboard/brand/center" },
      { key: "brand", title: "إعدادات الهوية الحالية", href: "/dashboard/brand" },
