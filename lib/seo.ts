...
export const LOCALE_SEO: Record<Locale, LocaleSEO> = {
  ar: {
    ...
    keywords: [
      ...
      "تبرع رمضان", "حملات تبرع خيرية", "جمعية خيرية إسلامية", "تبرع اونلاين",
    ...
    campaigns: {
      title: "حملات التبرع | جمعية قرة العيون – زكاة، صدقة، إغاثة إنسانية",
      description: "تصفح حملات التبرع الطبية والإنسانية الفعّالة. زكاتك وصدقتك تموّل عمليات عاجلة وعلاجات حيوية وكفالة أيتام للأسر السورية المحتاجة.",
    },
    about: {
