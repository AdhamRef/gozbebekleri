...
export const operationsHubSections: OperationsHubSection[] = [
  ...
  { key: "marketing-performance", title: "أداء الإعلانات", description: "ربط المحتوى بنتائج الحملات والإنفاق والتبرعات.", href: "/dashboard/operations/marketing-performance", priority: "PRIMARY" },
