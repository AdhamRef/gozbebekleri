...
export const operationsHubSections: OperationsHubSection[] = [
  ...
  { key: "messages", title: "مركز التواصل", description: "قنوات واتساب، الإيميل، SMS، القوالب، التدفقات، والمراجعة قبل الإرسال.", href: "/dashboard/operations/messaging", priority: "PRIMARY" },
