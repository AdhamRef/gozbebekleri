...
export const operationsHubSections: OperationsHubSection[] = [
  ...
  { key: "messages", title: "مركز التواصل", description: "قنوات واتساب، الإيميل، SMS، القوالب، التدفقات، والمراجعة قبل الإرسال.", href: "/dashboard/operations/communication", priority: "PRIMARY" },
  ...
  { key: "marketing-performance", title: "أداء الإعلانات", description: "ربط المحتوى بنتائج الحملات والإنفاق والتبرعات.", href: "/dashboard/operations/marketing-performance", priority: "SECONDARY" },
