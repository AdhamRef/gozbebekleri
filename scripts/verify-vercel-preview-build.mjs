...
const preflight = run("preflight:integration-settings");
const migration = run("verify:integration-settings-migration");
...
if (preflight.status !== 0 || !preflightAccepted || migration.status !== 0 || !migrationAccepted) {
  process.exit(1);
}
