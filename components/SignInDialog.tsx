    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md p-0 overflow-hidden" >
        <div className="relative">
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-gradient-to-br from-sky-500/20 to-blue-600/20 z-0" />
          ...
          <div className="relative z-10 p-6 pt-2 space-y-4 bg-white">
            ...
            <p className="text-xs text-center text-gray-500 mt-6">
              {t("termsAgreement")}{' '}
              <Link href="/terms" className="text-blue-600 hover:underline">{t("termsOfUse")}</Link>
              {' '}{t("and")}{' '}
