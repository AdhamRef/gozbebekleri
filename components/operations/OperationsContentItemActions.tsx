        ...
        <div className="mt-2 space-y-2 rounded-xl border bg-white p-3">
          ...
          {editing ? (
            <div className="grid gap-2 rounded-xl border bg-slate-50 p-3 text-xs sm:grid-cols-2">
              <label className="space-y-1 font-semibold text-slate-600 sm:col-span-2">العنوان<input value={form.title} onChange={(event) => setForm((value) => ({ ...value, title: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">النوع<input value={form.type} onChange={(event) => setForm((value) => ({ ...value, type: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">الحالة<select value={form.status} onChange={(event) => setForm((value) => ({ ...value, status: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand">{statusOptions.map(([value, label]) => <option key={value} value={value}>{label}</option>)}</select></label>
              <label className="space-y-1 font-semibold text-slate-600">القناة<input value={form.channel} onChange={(event) => setForm((value) => ({ ...value, channel: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">الموعد<input value={form.due} onChange={(event) => setForm((value) => ({ ...value, due: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">المسؤول<input value={form.owner} onChange={(event) => setForm((value) => ({ ...value, owner: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">اللغة<input value={form.language} onChange={(event) => setForm((value) => ({ ...value, language: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600 sm:col-span-2">المحور<input value={form.theme} onChange={(event) => setForm((value) => ({ ...value, theme: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600 sm:col-span-2">الفكرة / Hook<input value={form.hook} onChange={(event) => setForm((value) => ({ ...value, hook: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600 sm:col-span-2">الدعوة / CTA<input value={form.cta} onChange={(event) => setForm((value) => ({ ...value, cta: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">رابط Figma<input value={form.figmaUrl} onChange={(event) => setForm((value) => ({ ...value, figmaUrl: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">رابط Drive<input value={form.driveUrl} onChange={(event) => setForm((value) => ({ ...value, driveUrl: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">رابط الفيديو<input value={form.videoUrl} onChange={(event) => setForm((value) => ({ ...value, videoUrl: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600">النسخة النهائية<input value={form.finalAssetUrl} onChange={(event) => setForm((value) => ({ ...value, finalAssetUrl: event.target.value }))} className="w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
              <label className="space-y-1 font-semibold text-slate-600 sm:col-span-2">النص / ملاحظات الإنتاج<textarea value={form.copy} onChange={(event) => setForm((value) => ({ ...value, copy: event.target.value }))} className="min-h-20 w-full rounded-lg border bg-white px-3 py-2 text-slate-900 outline-none focus:border-brand" /></label>
