...
export default async function Fotogaleri() {
  ...
  return (
    ...
    {sortedData.map((post, index) => (
        <HaberlerListeBox key={index} bagid={index} baslik={post.title} img={"https://minberiaksa.org/uploads/"+post.picture} url={post.url} desc={post.summary} listtype={"videogaleri"}/>
    ))}
    </Grid>
    </Container>
    </main>
