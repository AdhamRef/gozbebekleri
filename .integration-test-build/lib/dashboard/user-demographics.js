...
exports.GENDER_LABEL_AR = void 0;
exports.normalizeGender = normalizeGender;
exports.parseGenderParam = parseGenderParam;
exports.genderQueryValues = genderQueryValues;
exports.parseBirthdate = parseBirthdate;
exports.ageFromBirthdate = ageFromBirthdate;
exports.birthdateRangeForAges = birthdateRangeForAges;
exports.parseAgeParam = parseAgeParam;
exports.formatBirthdateAr = formatBirthdateAr;
exports.GENDER_LABEL_AR = {
    male: "ذكر",
    female: "أنثى",
...
function normalizeGender(value) {
    ...
    if (!v)
        return null;
    if (MALE_TOKENS.has(v))
        return "male";
    if (FEMALE_TOKENS.has(v))
        return "female";
...
function ageFromBirthdate(value, today = new Date()) {
    ...
    if (mo < b.month || (mo === b.month && d < b.day))
        age -= 1;
    return age >= 0 && age <= 130 ? age : null;
}
function isoShift(today, yearsBack, daysForward = 0) {
 ...
 */
function birthdateRangeForAges(minAge, maxAge, today = new Date()) {
    const range = {};
    if (minAge !== null && Number.isFinite(minAge))
        range.lte = isoShift(today, minAge);
    if (maxAge !== null && Number.isFinite(maxAge))
        range.gte = isoShift(today, maxAge + 1, 1);
...
function formatBirthdateAr(value) {
    const b = parseBirthdate(value);
    if (!b)
        return null;
