...
exports.ACTION_PERMISSION_ROWS = exports.DASHBOARD_PERMISSION_ROWS = exports.DASHBOARD_NAV_HREFS_ORDERED = exports.DASHBOARD_NAV_GROUPS = void 0;
exports.dashboardHrefToPermissionKey = dashboardHrefToPermissionKey;
exports.resolveActiveDashboardHref = resolveActiveDashboardHref;
...
exports.DASHBOARD_NAV_HREFS_ORDERED = exports.DASHBOARD_NAV_GROUPS.flatMap((g) => g.items.map((i) => i.href));
function dashboardHrefToPermissionKey(href) {
    for (const g of exports.DASHBOARD_NAV_GROUPS) {
...
function resolveActiveDashboardHref(pathname, hrefs) {
    return [...hrefs]
        .filter((href) => pathname === href || (href !== "/dashboard" && pathname.startsWith(`${href}/`)))
        .sort((a, b) => b.length - a.length)[0] ?? null;
}
exports.DASHBOARD_PERMISSION_ROWS = [
...
exports.ACTION_PERMISSION_ROWS = [
    {
        key: "reportsExport",
