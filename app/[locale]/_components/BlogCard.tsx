  ...
  return (
    ...
    <div className="group relative bg-white rounded-xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 cursor-pointer h-[280px] sm:h-[320px]">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 text-white">
        <h3 className="text-base sm:text-lg font-bold mb-2 sm:mb-3 line-clamp-2 group-hover:text-sky-400 transition-colors duration-300">
          {title}
        </h3>
        <span className="inline-flex items-center gap-1 text-sky-400 font-semibold group-hover:text-sky-300 text-xs sm:text-sm transition-colors">
          المزيد
