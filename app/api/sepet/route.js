...
export async function POST(req,res) {
    ...
    let baskettoken = data.baskettoken;
    ...
    let regular_payment = data.regular_payment;
    let regular_repeat = data.regular_repeat;
    let regular_repeatDay = data.regular_repeatDay;
    let msg = data.msg;
    ...
    //postbody['token'] = "123123asd123asd444";
    
    postbody['eventtype'] = "basket";
    postbody['logstoken'] = "";
    postbody['msg'] = msg;
    postbody['modulkey'] = "66ec1f15012d3f025450cf6a";
   // postbody['key'] = "671f7968012d3f025450d050";
    postbody['name'] = "Genel Bağış";
    ...
    postbody['pricetype'] = pricetype;
    postbody['todaycurrency'] = "usd";
    postbody['date'] = "2024-06-19";
    postbody['datetime'] = "2024-06-19T17:05:20.742Z";
    postbody['personname'] = name;
    postbody['personemail'] = email;
    postbody['personphone'] = phone;
    postbody['persontype'] = persontype;
    postbody['status'] = "active";
    postbody['key'] = key;

    if(baskettoken != undefined){
        postbody['baskettoken'] = baskettoken;
    }
    ...
    if(regular_payment=="1"){
        postbody['regular_payment'] = regular_payment;
        postbody['regular_repeat'] = regular_repeat;
        postbody['regular_repeatDay'] = regular_repeatDay;
    }
    ...
    try{
        ...
        let responsea = NextResponse.json(data, {
            status: 200,
        });

        if(data.status){
            let paymenttoken = data.paymenttoken;
            responsea.cookies.set({
                name: 'paymenttoken',
                value: paymenttoken,
                httpOnly: true,
                //sameSite: 'None'
