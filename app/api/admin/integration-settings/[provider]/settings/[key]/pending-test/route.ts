...
import { pendingSettingTestSchema } from "@/lib/integration-settings/api-contracts";
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  const parsed = pendingSettingTestSchema.safeParse(await request.json().catch(() => null));
