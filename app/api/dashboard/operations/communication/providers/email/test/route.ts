...
export async function POST(req: NextRequest) {
  ...
  const created = await createDeliveryRecord({ channel: "EMAIL", provider: "BREVO_EMAIL", recipientEmail: to, locale: "ar", purpose: "UTILITY", origin: "TEST", renderedSubject: subject, renderedBody: html, createdBy: actor.actorId, status: "RENDERED" });
