...
export default async function CampaignPerformancePage() {
  ...
  return <main className="space-y-5" dir="rtl">
    <header><p className="text-xs font-bold text-[#025EB8]">التسويق / أداء الحملات</p><h1 className="mt-1 text-2xl font-black">أداء الحملات</h1><p className="mt-2 text-sm leading-6 text-slate-500">قراءة موحدة للحملات من بيانات الإنفاق الفعلية وإسناد التبرعات داخل الموقع.</p></header>
