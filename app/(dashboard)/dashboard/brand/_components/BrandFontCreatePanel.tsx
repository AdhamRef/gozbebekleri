  ...
  return (
    <section className="rounded-lg border bg-white p-4 shadow-sm" aria-label="إضافة خط هوية">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="text-xs font-bold text-[#025EB8]">إضافة خط</p>
      ...
      <form onSubmit={submit} className="mt-4 grid gap-3 lg:grid-cols-[1fr_1.2fr_1fr_1fr_auto]">
        ...
        <Input value={fallback} onChange={(event) => setFallback(event.target.value)} placeholder="الخط البديل" maxLength={180} aria-label="الخط البديل" dir="ltr" />
