  ...
  return (
    <div className="space-y-5" dir="rtl">
      <div className="rounded-2xl border bg-gradient-to-l from-slate-950 via-brand to-slate-900 p-5 text-white shadow-sm">
        <p className="text-xs text-white/70">المساعد الذكي / سياق المحتوى</p>
        <h1 className="mt-1.5 text-xl sm:text-2xl font-bold tracking-tight">مساعد المحتوى الذكي</h1>
        <p className="mt-2 max-w-4xl text-sm leading-6 text-white/85">
          نسخة آمنة لمساعد المحتوى. لا يتصل بأي مزود خارجي إلا عند تفعيل مفاتيح السيرفر صراحةً، ويحدد الصلاحيات والمصادر قبل أي استخدام حقيقي.
        </p>
      </div>
