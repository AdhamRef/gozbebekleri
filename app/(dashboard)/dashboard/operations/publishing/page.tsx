...
export default async function OperationsPublishingPage() {
  ...
  return (
    <div className="space-y-5 p-4 sm:p-6" dir="rtl">
      <div className="flex flex-col gap-4 rounded-2xl border bg-gradient-to-l from-slate-950 via-[#025EB8] to-slate-900 p-5 text-white shadow-sm lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="text-xs text-white/70">Content & Operations / Publishing</p>
          <h1 className="mt-1.5 text-2xl font-black">النشر اليدوي</h1>
          <p className="mt-2 max-w-4xl text-sm leading-6 text-white/85">
            Checklist تشغيلية لكل مادة محتوى عبر المنصات. كل الأزرار تسجل حالة بشرية فقط ولا تنشر تلقائيًا ولا تتصل بأي منصة خارجية.
          </p>
