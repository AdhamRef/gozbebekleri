  ...
  return (
    <div className="space-y-5 p-4 sm:p-6" dir="rtl">
      <div className="flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="text-xs font-bold text-[#025EB8]">العمليات / مركز الأرشيف</p>
          <h1 className="mt-1 text-xl font-black text-slate-900">مركز الأرشيف</h1>
          <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-600">
            ذاكرة المواد المنتجة: فيديوهات، تصاميم، رسائل، كاروسيل، وإعلانات مع ربطها بالموسم والحملة والنتيجة.
          </p>
        </div>
        <Link href="/dashboard/operations/production" className="inline-flex items-center justify-center gap-2 rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-bold text-slate-700 transition hover:border-[#025EB8]/50 hover:text-[#025EB8]">
          فتح لوحة الإنتاج
