  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <div className="flex flex-wrap items-center justify-end gap-1.5">
        <Link href={`${BASE}/${id}`} className="inline-flex h-7 items-center gap-1 rounded-md border border-slate-200 bg-white px-2 text-[11px] font-bold text-[#025EB8] hover:bg-slate-50"><FolderOpen className="h-3 w-3" /> فتح</Link>
