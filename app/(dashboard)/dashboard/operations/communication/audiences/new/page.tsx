    ...
    <main className="space-y-5" dir="rtl">
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <p className="text-xs font-bold text-brand">الجمهور / {defaultType === "TEST" ? "قائمة اختبار جديدة" : "قائمة مخصصة جديدة"}</p>
            <h1 className="mt-1 text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">{defaultType === "TEST" ? "إنشاء قائمة اختبار" : "إنشاء قائمة مخصصة"}</h1>
