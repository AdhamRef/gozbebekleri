    ...
    <main className="space-y-5 p-4 sm:p-6" dir="rtl">
      <section className="rounded-2xl border bg-gradient-to-l from-slate-950 to-[#025EB8] p-5 text-white shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <p className="text-xs text-white/70">القوالب / إنشاء قالب</p>
            <h1 className="mt-1.5 text-2xl font-black">إنشاء قالب</h1>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-white/85">اختر النوع والقناة واللغة، جهّز المحتوى والمتغيرات، ثم عاين واحفظ.</p>
          </div>
