    ...
    <main className="space-y-5 p-4 sm:p-6" dir="rtl">
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <p className="text-xs font-bold text-[#025EB8]">القوالب / تصاميم الإيميل الثابتة</p>
            <h1 className="mt-1 text-xl font-black text-slate-900">تصاميم الإيميل الثابتة</h1>
          ...
          <Link href="/dashboard/operations/communication/templates" className="inline-flex h-9 shrink-0 items-center gap-2 rounded-md border border-slate-300 bg-white px-4 text-sm font-bold text-slate-700 transition hover:border-[#025EB8]/50 hover:text-[#025EB8]">العودة للقوالب <ArrowLeft className="h-4 w-4" /></Link>
        </div>
      </section>
